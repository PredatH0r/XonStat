...
function createGameTypeStrategy(gametype) {
  ...
  var ValidateMatchForGametype = {
    ...
    "ctf": function(game) { return Math.max(game.matchStats.TSCORE0, game.matchStats.TSCORE1) >= 5  || Math.abs(game.matchStats.TSCORE0 - game.matchStats.TSCORE1) >= 5 || game.matchStats.GAME_LENGTH >= 10 * 60 },
